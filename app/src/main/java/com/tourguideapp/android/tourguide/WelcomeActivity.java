...
public class WelcomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /* Launch HomeScreen Activity */
    private void launchHomeScreen()
    {
        // check in SharedPreferences if the app is used for first time
        Globals.saveFirstTimeLaunch(false);
        startActivity(new Intent(WelcomeActivity.this, MainMenu.class));
        finish();
    }

    /* Add Index Dots for the Slider  */
    ...
    /* Update the Bottom Indexing Dots of Slider */
